...
class AppointmentsRecord extends FirestoreRecord {
  ...
  // "appointmentPrice" field.
  int? _appointmentPrice;
  int get appointmentPrice => _appointmentPrice ?? 0;
  bool hasAppointmentPrice() => _appointmentPrice != null;
  ...
  void _initializeFields() {
    ...
    _appointmentPrice = castToType<int>(snapshotData['appointmentPrice']);
...
class AppointmentsRecordDocumentEquality
  ...
  bool equals(AppointmentsRecord? e1, AppointmentsRecord? e2) {
    return e1?.appointmentName == e2?.appointmentName &&
        ...
        e1?.appointmentPrice == e2?.appointmentPrice &&
        e1?.userID == e2?.userID;
  }
